...
const ASSETS = [
  ...
  { name: 'banner_facebook', label: 'Bannière Facebook', size: '1440x720', prompt: 'Facebook cover banner for tech startup, modern, purple indigo gradient, clean layout, professional, high quality' },
  ...
  { name: 'banner_linkedin', label: 'Bannière LinkedIn', size: '1440x720', prompt: 'LinkedIn cover banner for AI tech company, corporate, purple indigo gradient, professional, clean, high quality' },
  { name: 'banner_youtube', label: 'Bannière YouTube', size: '1440x720', prompt: 'YouTube channel banner for AI tech channel, vibrant, purple indigo gradient, modern, high quality' },
  ...
  { name: 'ad_facebook', label: 'Pub Facebook', size: '1440x720', prompt: 'Facebook ad creative for AI platform, eye-catching, purple indigo gradient, promotional, modern, high quality' },
...
- \`afrilaunch-banner_facebook.png\` — Cover Facebook 1440x720
- \`afrilaunch-banner_instagram.png\` — Post Instagram 1024x1024
- \`afrilaunch-banner_linkedin.png\` — Cover LinkedIn 1440x720
- \`afrilaunch-banner_youtube.png\` — Cover YouTube 1440x720

## Favicon
- \`afrilaunch-favicon.png\` — Favicon 1024x1024

## Créatives Publicitaires
- \`afrilaunch-ad_facebook.png\` — Ad Facebook 1440x720
